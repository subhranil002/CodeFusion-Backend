...
const register = asyncHandler(async (req, res, next) => {
    try {
        ...
        return next(new ApiError(`user.controller :: register: ${error}`, error.statusCode || 500));
    }
});
const login = asyncHandler(async (req, res, next) => {
    try {
        ...
        return next(new ApiError(`user.controller :: login: ${error}`, error.statusCode || 500));
    }
});
...
const logout = asyncHandler(async (req, res, next) => {
    try {
        ...
        return next(new ApiError(`user.controller :: logout: ${error}`, error.statusCode || 500));
    }
});
const changeAvatar = asyncHandler(async (req, res, next) => {
    try {
        ...
        const updatedUser = await updateAvatar(req.user, avatarLocalPath);
        return res
            .status(200)
        ...
        return next(new ApiError(`user.controller :: changeAvatar: ${error}`, error.statusCode || 500));
    }
});
const getProfile = asyncHandler(async (req, res, next) => {
    try {
        ...
        return next(new ApiError(`user.controller :: getProfile: ${error}`, error.statusCode || 500));
    }
});
const updateProfile = asyncHandler(async (req, res, next) => {
    try {
        ...
        return next(new ApiError(`user.controller :: updateProfile: ${error}`, error.statusCode || 500));
    }
});
const forgotPassword = asyncHandler(async (req, res, next) => {
    try {
        ...
        return next(new ApiError(`user.controller :: forgotPassword: ${error}`, error.statusCode || 500));
    }
});
const resetPassword = asyncHandler(async (req, res, next) => {
    try {
        ...
        return next(new ApiError(`user.controller :: resetPassword: ${error}`, error.statusCode || 500));
    }
});
const changePassword = asyncHandler(async (req, res, next) => {
    try {
        ...
        return next(new ApiError(`user.controller :: changePassword: ${error}`, error.statusCode || 500));
    }
});
const getMyRooms = asyncHandler(async (req, res, next) => {
    try {
        ...
        return next(new ApiError(`user.controller :: getMyRooms: ${error}`, error.statusCode || 500));
    }
});
const contactUs = asyncHandler(async (req, res, next) => {
    try {
        ...
        return next(new ApiError(`user.controller :: contactUs: ${error}`, error.statusCode || 500));
    }
});
export { register, login, guestLogin, logout, changeAvatar, getProfile, updateProfile, forgotPassword, resetPassword, changePassword, getMyRooms, contactUs, };
