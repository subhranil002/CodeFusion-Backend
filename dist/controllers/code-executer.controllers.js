...
export const getLanguages = asyncHandler(async (req, res, next) => {
    try {
        ...
        return next(new ApiError(`code-executer.controller :: getLanguages :: ${error}`, error.statusCode || 500));
    }
});
export const codeRunner = asyncHandler(async (req, res, next) => {
    try {
        ...
        return next(new ApiError(`code-executer.controller :: codeRunner :: ${error}`, error.statusCode || 500));
    }
});
